...
Takeaway: think carefully about who is going to use your predictions. If it is another data professional, maybe returning raw probabilities makes sense. However, if it is a non-technical audience, then simply giving them extra "bonus" information can muddy the waters.
...
Takeaways: Hierarchical behaviour can make probabilities and confidences very confusing if all combinations of label aren't allowed. This may have to be accounted for, particularly if you are "underselling" how good your predictions are due to the dilution effects of non-allowed category combinations.
...
* There are a number of "gotchas" associated with packaging probability into a usable confidence score. Possibly the most important is the granularity required.
